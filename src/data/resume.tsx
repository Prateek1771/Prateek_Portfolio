  ...
  work: [
    {
      ...
      description:
        "Led the redesign of an Automated Optical Inspection system for industrial cable assembly, replacing a YOLO-based pipeline with an OpenCV detection system and increasing inspection accuracy from 65% to 99% while reducing deployment hardware requirements. Designed and implemented a multi-step agentic workflow that extracts required fields from inspection data and generates standards-conformant reports across multiple ISO guideline sets. Led development of an AI operations console proof of concept with role-based access control, audit logging, RAG-backed reporting, and AI guardrails; presented the system on-site to the client. Investigated a production API-key security incident involving 166M+ tokens and approximately $758 in usage, identifying a CLI authentication path that allowed API-key revocation controls to be bypassed. Engineered a multi-platform AI chatbot integrating WhatsApp, website, and Instagram to provide conversational access to business data for customers, prospects, and employees; increased daily new-customer engagement by approximately 5 times (5–6 to 25–30 users per day) and reduced manual effort for internal teams.",
      technologies: [
        "Python",
        "OpenCV",
        "YOLO",
      ...
      highlights: [
        "Led the redesign of an Automated Optical Inspection system for industrial cable assembly, replacing a YOLO-based pipeline with an OpenCV detection system and increasing inspection accuracy from 65% to 99% while reducing deployment hardware requirements.",
        "Designed and implemented a multi-step agentic workflow that extracts required fields from inspection data and generates standards-conformant reports across multiple ISO guideline sets.",
        "Led development of an AI operations console proof of concept with role-based access control, audit logging, RAG-backed reporting, and AI guardrails; presented the system on-site to the client.",
        "Investigated a production API-key security incident involving 166M+ tokens and approximately $758 in usage, identifying a CLI authentication path that allowed API-key revocation controls to be bypassed.",
        "Engineered a multi-platform AI chatbot integrating WhatsApp, website, and Instagram to provide conversational access to business data for customers, prospects, and employees; increased daily new-customer engagement by approximately 5 times (5–6 to 25–30 users per day) and reduced manual effort for internal teams.",
      ],
    },
    {
